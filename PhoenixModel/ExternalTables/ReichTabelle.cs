...
namespace PhoenixModel.ExternalTables
{
    public class ReichTabelle
    {
        ...
        public static ReichTabelle[] Vorbelegung =
        {
                ...
                new ReichTabelle( 4, ["vir vachal", "virvachal","union von vir'vachal und asimilan", "uva", "u.v.a."], "hellgrün", "#A0EEA0") ,
                new ReichTabelle( 5, ["avallon"], "dunkelgrün","#006700") ,
                new ReichTabelle( 6, ["northeim"], "weiß","#FFFFFF" ) ,
                new ReichTabelle( 7, ["helborn"],"schwarz", "#303030") ,
