...
namespace PhoenixModel.ExternalTables
{
    public class ReichTabelle
    {
        ...
        public static ReichTabelle[] Vorbelegung =
        {
                ...
                new ReichTabelle( 4, ["vir vachal", "virvachal","union von vir'vachal und asimilan", "uva", "u.v.a."], "hellgrün", "#90EE90") ,
                new ReichTabelle( 5, ["avallon"], "dunkelgrün","#4a6741") ,
                ...
                new ReichTabelle( 9, ["piraten", "choson", "pirat", "purple puppy pirates", "ppp"],"blau", "#0000FF"),
                new ReichTabelle( 10, ["o'har", "ohar"], "rot", "#FF0000") ,
