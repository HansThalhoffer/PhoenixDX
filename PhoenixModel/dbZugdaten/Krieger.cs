...
namespace PhoenixModel.dbZugdaten {
    public class Krieger : TruppenSpielfigur, IDatabaseTable, IEigenschaftler
    {
        ...
        public override FigurType BaseTyp => FigurType.Krieger;
        public override FigurType Typ
        {
            get
            {
                if (SKP > 0)
                    return FigurType.SchwereArtillerie;
                if (LKP > 0)
                    return FigurType.LeichteArtillerie;
                return FigurType.Krieger;
            }
        }
        ...
        INSERT INTO {TableName} (
            ...
            {this.x9}, {this.y9}, {DatabaseConverter.SqlText(this.auf_Flotte)}, 
