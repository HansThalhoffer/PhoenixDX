...
namespace PhoenixModel.dbZugdaten {
    public class Schiffe : TruppenSpielfigur, IDatabaseTable, IEigenschaftler
    {
        ...
        INSERT INTO {TableName} (
            ...
            x7, y7, x8, y8, x9, y9, hoehenstufen, schritt, auf_Flotte, Sonstiges, 
            ...
            {this.gf_von}, {this.kf_von}, {this.gf_nach}, {this.kf_nach}, {this.rp}, {this.bp}, 
            {DatabaseConverter.SqlText(this.ph_xy)}, {(this.Garde ? 1 : 0)}, 
            {DatabaseConverter.SqlText(this.Befehl_bew)}, {DatabaseConverter.SqlText(this.Befehl_ang)}, 
            {DatabaseConverter.SqlText(this.Befehl_erobert)}, {this.GS}, {this.GS_alt}, 
            {this.Kampfeinnahmen}, {this.Kampfeinnahmen_alt}, {this.x1}, {this.y1}, {this.x2}, {this.y2}, 
            {this.x3}, {this.y3}, {this.x4}, {this.y4}, {this.x5}, {this.y5}, {this.x6}, {this.y6}, 
            {this.x7}, {this.y7}, {this.x8}, {this.y8}, {this.x9}, {this.y9}, {this.hoehenstufen}, 
            {this.schritt}, {DatabaseConverter.SqlText(this.auf_Flotte)}, 
            {DatabaseConverter.SqlText(this.Sonstiges)}, {DatabaseConverter.SqlText(this.spaltetab)}, 
            {DatabaseConverter.SqlText(this.fusmit)}, {DatabaseConverter.SqlText(this.chars)}, 
