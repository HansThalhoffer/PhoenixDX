...
namespace PhoenixModel.dbZugdaten {
    ...
    public class ZugdatenSettings: PzeSettingsMaster, IDatabaseTable, IEigenschaftler
    {
        ...
        UPDATE {TableName} SET
            Monat = {this.Monat},
            Reich = {this.Reich},
            Reichsname = {DatabaseConverter.SqlText(this.Reichsname)},
            dbversion = {DatabaseConverter.SqlText(this.dbversion)},
        ...
        INSERT INTO {TableName} (
            ...
            {this.Monat},
            {this.Reich},
            {DatabaseConverter.SqlText(this.Reichsname)},
            {DatabaseConverter.SqlText(this.dbversion)},
            {this.Ruestmonat},
            {this.Invasorflag},
            {this.Audvacargeld},
            {this.Piratenflag},
