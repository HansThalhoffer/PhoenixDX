...
namespace PhoenixModel.dbZugdaten {
    public class Reiter : TruppenSpielfigur, IDatabaseTable, IEigenschaftler
    {
        ...
        UPDATE {TableName} SET
            ...
            Befehl_bew = {DatabaseConverter.SqlText(this.Befehl_bew)},
            Befehl_ang = {DatabaseConverter.SqlText(this.Befehl_ang)},
            Befehl_erobert = {DatabaseConverter.SqlText(this.Befehl_erobert)},
            GS = {this.GS},
            GS_alt = {this.GS_alt},
            ...
            auf_Flotte = {DatabaseConverter.SqlText(this.auf_Flotte)},
            Sonstiges = {DatabaseConverter.SqlText(this.Sonstiges)},
            spaltetab = {DatabaseConverter.SqlText(this.spaltetab)},
            fusmit = {DatabaseConverter.SqlText(this.fusmit)},
            chars = {DatabaseConverter.SqlText(this.chars)},
            bp_max = {this.bp_max},
        ...
        INSERT INTO {TableName} (
            ...
            Garde, Befehl_bew, Befehl_ang, Befehl_erobert, GS, GS_alt, 
            Kampfeinnahmen, Kampfeinnahmen_alt, x1, y1, x2, y2, x3, y3, x4, y4, 
            x5, y5, x6, y6, x7, y7, x8, y8, x9, y9, hoehenstufen, schritt, 
            auf_Flotte, Sonstiges, spaltetab, fusmit, chars, bp_max, isbanned, 
            x10, y10, x11, y11, x12, y12, x13, y13, x14, y14, x15, y15, x16, y16, 
            x17, y17, x18, y18, x19, y19
        ) VALUES (
            ...
            {DatabaseConverter.SqlText(this.ph_xy)}, {(this.Garde ? 1 : 0)}, 
            {DatabaseConverter.SqlText(this.Befehl_bew)}, 
            {DatabaseConverter.SqlText(this.Befehl_ang)}, 
            {DatabaseConverter.SqlText(this.Befehl_erobert)}, 
            {this.GS}, {this.GS_alt}, {this.Kampfeinnahmen}, {this.Kampfeinnahmen_alt}, 
            {this.x1}, {this.y1}, {this.x2}, {this.y2}, {this.x3}, {this.y3}, 
            {this.x4}, {this.y4}, {this.x5}, {this.y5}, {this.x6}, {this.y6}, 
            {this.x7}, {this.y7}, {this.x8}, {this.y8}, {this.x9}, {this.y9}, 
            {this.hoehenstufen}, {this.schritt}, {DatabaseConverter.SqlText(this.auf_Flotte)}, 
            {DatabaseConverter.SqlText(this.Sonstiges)}, 
            {DatabaseConverter.SqlText(this.spaltetab)}, 
            {DatabaseConverter.SqlText(this.fusmit)}, 
            {DatabaseConverter.SqlText(this.chars)}, {this.bp_max}, {this.isbanned}, 
